...
Begin VB.Form listcon3 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "PH Confined Patients List"
   ClientHeight    =   4560
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10455
   Icon            =   "listcon3.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4560
   ...
   Begin VB.ComboBox combodate 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "listcon3.frx":0BC2
      Left            =   2040
      List            =   "listcon3.frx":0C26
      TabIndex        =   4
      Top             =   3000
      Width           =   735
   End
   Begin VB.ComboBox combomonth 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "listcon3.frx":0CA3
      Left            =   120
      List            =   "listcon3.frx":0CCE
      TabIndex        =   3
      Top             =   3000
      Width           =   1815
   End
   Begin VB.Frame framecon 
      Caption         =   "PH Confined Patient(s)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
