...
Begin VB.Form srchFormP 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "srchformP.frx":0442
      ...
      Begin VB.Frame Frame1 
         ...
         Begin Project1.chameleonButton srchbut2 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "srchformP.frx":045E
            PICN            =   "srchformP.frx":047A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
...
End If
 ...
 PHconfined.memtext2.Text = TRS.Fields(3)
 PHconfined.memtext3.Text = TRS.Fields(4)
         ...
         If TRS.RecordCount > 0 Then
            TRS.Fields.Refresh
             Do While Not TRS.EOF
                Set List = PHconfined.ListView.ListItems.Add(, , TRS.Fields(0))
                With List
