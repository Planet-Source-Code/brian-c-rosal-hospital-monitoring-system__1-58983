...
Begin VB.Form srchform 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Search PH Member"
   ClientHeight    =   4095
   ClientLeft      =   3345
   ClientTop       =   2310
   ClientWidth     =   4440
   Icon            =   "srchform.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "srchform.frx":0442
      ...
      Begin VB.Frame Frame1 
         ...
         Begin Project1.chameleonButton srchbut2 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "srchform.frx":045E
            PICN            =   "srchform.frx":047A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
...
End If
 ...
 '/*******Displaying of records the scanhead : david bry ****/
  ...
  For X = 0 To 5
  PHmember.txtmem(X).Text = TRS.Fields(X)
  Next X
 ...
 'yaH im searchin?
     ...
     If Madz = True Then
        Set TRS = DBMain.OpenRecordset(search_sql)
         PHmember.ListView.ListItems.Clear
         If TRS.RecordCount > 0 Then
            TRS.Fields.Refresh
             Do While Not TRS.EOF
                Set List = PHmember.ListView.ListItems.Add(, , TRS.Fields(0))
                With List
               ...
               TRS.MoveNext
            Loop
            PHmember.cmdreset.Enabled = True
          Else
