...
Begin VB.Form listcon4 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Confined Patient(s) List  [ PH-Med/Non-Med ]"
   ClientHeight    =   4515
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10500
   Icon            =   "listcon4.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4515
   ...
   Begin VB.Frame framecon 
      Caption         =   "All Confined Patient(s)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.ComboBox combomonth 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "listcon4.frx":0BC2
      Left            =   135
      List            =   "listcon4.frx":0BED
      TabIndex        =   9
      Top             =   2955
      Width           =   1815
   End
   Begin VB.ComboBox combodate 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "listcon4.frx":0C59
      Left            =   2055
      List            =   "listcon4.frx":0CBD
      TabIndex        =   8
      Top             =   2955
      Width           =   735
   End
